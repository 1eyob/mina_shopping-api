const { getCoversation, sendMessage, getAllMessageByConversationId, checkCoversationBetweenTwoUsers, createCoversation } = require("../models/conversationModel")
...
module.exports={
    ...
    GetMessageByConversationId:(req,res)=>{
        ...
        getAllMessageByConversationId(req.params,(error,result)=>{
            if(error){
                res.json({
                    status:404,
                    message:error
